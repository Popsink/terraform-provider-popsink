...
The Popsink Terraform Provider allows you to manage Popsink teams and connectors using Infrastructure as Code.
...
- **Resources**: See [docs/resources/](./docs/resources/) for detailed documentation on each resource
  ...
  - [popsink_connector](./docs/resources/connector.md) - Source and target connectors
